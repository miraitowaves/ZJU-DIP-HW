...
double calcSpaceDistance(int h1, int w1, int h2, int w2) {
    return pow(h1 - h2, 2) + pow(w1 - w2, 2);
}
...
double calcColorDistance(BMP_File* bmpFilePtr, int h1, int w1, int h2, int w2) {
    return pow(bmpFilePtr->data[h1][w1].rgbGreen - bmpFilePtr->data[h2][w2].rgbGreen, 2)
    + pow(bmpFilePtr->data[h1][w1].rgbRed - bmpFilePtr->data[h2][w2].rgbRed, 2)
    + pow(bmpFilePtr->data[h1][w1].rgbBlue - bmpFilePtr->data[h2][w2].rgbBlue, 2);
}
